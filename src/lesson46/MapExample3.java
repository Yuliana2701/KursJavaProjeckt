...
public class MapExample3 {
    public static void main(String[] args) {
        ...
        System.out.println(map.put(11, "orange"));//если такого ключа нет добавляется новая ключ-пара(key-value)
        ...
        //foreach()-перебор всех пар-ключ значений с возможностью применить к ним какую-то функцию
